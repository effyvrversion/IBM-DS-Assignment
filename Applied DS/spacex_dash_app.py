...
def get_scatter_chart(entered_site, payload_slider):
     ...
     if entered_site == 'ALL':
         sca1 = px.scatter(filtered_data, x="Payload Mass (kg)", y="class", color="Booster Version Category")
         return sca1
     else:
         ...
         sca2 = px.scatter(filtered_data, x="Payload Mass (kg)", y="class", color="Booster Version Category")
         return sca2
